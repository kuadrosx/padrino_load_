...
database_name = case Padrino.env
  when :development then 'load_mongoid_development'
  when :production  then 'load_mongoid_production'
  when :test        then 'load_mongoid_test'
end
...
#     sessions:
#       default:
#         database: load_mongoid_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: load_mongoid_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: load_mongoid_test
#         hosts:
#           - localhost:27017
#
#
